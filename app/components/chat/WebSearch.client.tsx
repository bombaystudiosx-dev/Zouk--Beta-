...
export function WebSearch({ onSearchResult, disabled = false }: WebSearchProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        {isSearching ? (
          <div className="i-svg-spinners:90-ring-with-bg text-zouk-elements-loader-progress text-xl animate-spin" />
        ) : (
      ...
      {isOpen && (
        <div
          className={classNames(
            ...
            'rounded-lg border border-zouk-elements-borderColor bg-zouk-elements-background-depth-2 p-2 shadow-lg',
          )}
        >
          <input
            ref={inputRef}
            ...
            className={classNames(
              ...
              'bg-zouk-elements-background-depth-1 text-zouk-elements-textPrimary',
              'placeholder-zouk-elements-textTertiary',
          ...
          <button
            ...
            className={classNames(
              ...
              'bg-zouk-elements-button-primary-background text-zouk-elements-button-primary-text',
