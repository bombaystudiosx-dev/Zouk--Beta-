      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-zouk-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-zouk-elements-item-backgroundAccent hover:bg-zouk-elements-artifacts-backgroundHover"
