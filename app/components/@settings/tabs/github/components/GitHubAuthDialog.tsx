  ...
  return (
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        >
          <motion.div
            className="bg-zouk-elements-background border border-zouk-elements-borderColor rounded-lg shadow-lg"
          ...
          >
            <div className="p-6 space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-zouk-elements-textPrimary">Connect to GitHub</h2>
                <button
                  onClick={handleClose}
                  className="p-1 rounded-md hover:bg-zouk-elements-item-backgroundActive/10"
                >
                  <div className="i-ph:x w-4 h-4 text-zouk-elements-textSecondary" />
                </button>
              </div>

              <div className="text-xs text-zouk-elements-textSecondary bg-zouk-elements-background-depth-1 p-3 rounded-lg">
              ...
              <form onSubmit={handleConnect} className="space-y-4">
                <div>
                  <label className="block text-sm text-zouk-elements-textSecondary mb-2">Token Type</label>
                  <select
                    value={tokenType}
                    ...
                    className={classNames(
                      ...
                      'focus:outline-none focus:ring-1 focus:ring-zouk-elements-item-contentAccent',
                      'disabled:opacity-50',
                    )}
                  >
                ...
                <div>
                  <label className="block text-sm text-zouk-elements-textSecondary mb-2">
                ...
                <div className="flex items-center justify-end gap-3 pt-4">
                  <button
                    type="button"
                    onClick={handleClose}
                    className="px-4 py-2 text-sm text-zouk-elements-textSecondary hover:text-zouk-elements-textPrimary"
                  >
                    Cancel
                  </button>
                  <button
