  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-zouk-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-zouk-elements-background-depth-2 border-y border-zouk-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-zouk-elements-terminals-buttonBackground text-zouk-elements-textSecondary hover:text-zouk-elements-textPrimary':
                            isActive,
                          'bg-zouk-elements-background-depth-2 text-zouk-elements-textSecondary hover:bg-zouk-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-zouk-elements-terminals-buttonBackground text-zouk-elements-textPrimary': isActive,
                            'bg-zouk-elements-background-depth-2 text-zouk-elements-textSecondary hover:bg-zouk-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-zouk-elements-textTertiary hover:text-zouk-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting zouk terminal [${index}]`);
