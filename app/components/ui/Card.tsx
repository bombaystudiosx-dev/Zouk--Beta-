  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-zouk-elements-borderColor bg-zouk-elements-background-depth-1 text-zouk-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-zouk-elements-textSecondary', className)} {...props} />;
  },
);
