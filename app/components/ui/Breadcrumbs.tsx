      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-zouk-elements-textPrimary dark:text-zouk-elements-textPrimary-dark'
              : 'text-zouk-elements-textSecondary dark:text-zouk-elements-textSecondary-dark hover:text-zouk-elements-textPrimary dark:hover:text-zouk-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-zouk-elements-textTertiary dark:text-zouk-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
