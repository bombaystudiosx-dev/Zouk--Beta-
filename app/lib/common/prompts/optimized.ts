...
<artifact_info>
  ...
  - Use \`<zoukArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<zoukAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<zoukArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<zoukAction>\` tags with appropriate \`type\` attribute:
