...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out zouk artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <zouk', 'Foo bar '],
      ['Foo bar <zouka', 'Foo bar <zouka'],
      ['Foo bar <zoukA', 'Foo bar '],
      ['Foo bar <zoukArtifacs></zoukArtifact>', 'Foo bar <zoukArtifacs></zoukArtifact>'],
      ['Before <oltArtfiact>foo</zoukArtifact> After', 'Before <oltArtfiact>foo</zoukArtifact> After'],
      ['Before <zoukArtifactt>foo</zoukArtifact> After', 'Before <zoukArtifactt>foo</zoukArtifact> After'],
    ])('should correctly parse chunks and strip out zouk artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <zoukArtifact title="Some title" id="artifact_1">foo bar</zoukArtifact> Some more text',
        {
      ...
      [
        [
          'Some text before <zoukArti',
          'fact',
          ' title="Some title" id="artifact_1" type="bundled" >foo</zoukArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' ',
          '>',
          'foo</zoukArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <zoukArtifact title="Some title" id="artifact_1">foo</zoukArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <zoukArtifact title="Some title" id="artifact_1"><zoukAction type="shell">npm install</zoukAction></zoukArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <zoukArtifact title="Some title" id="artifact_1"><zoukAction type="shell">npm install</zoukAction><zoukAction type="file" filePath="index.js">some content</zoukAction></zoukArtifact> After',
        {
          output: 'Before  After',
